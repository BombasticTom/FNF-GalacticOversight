...
class DiscordClient
{
	...
	private inline static final _defaultID:String = "1312410907887931422";
	...
	private static function onReady(request:cpp.RawConstPointer<DiscordUser>):Void
	{
		...
		final modDownloadButton:DiscordButton = DiscordButton.create();
		modDownloadButton.label = "Download!";
		modDownloadButton.url = "https://gamebanana.com/mods/558797";
		presence.button1 = modDownloadButton;
	...
	public static function changePresence(details:String = 'In the Menus', ?state:String, ?smallImageKey:String, ?hasStartTimestamp:Bool, ?endTimestamp:Float, largeImageKey:String = 'icon')
	{
		...
		presence.largeImageText = "Build version: " + states.MainMenuState.prettyBuildVersion;
...
private final class DiscordPresence
{
	...
	public var button1(default, set):DiscordButton;
	public var button2(default, set):DiscordButton;
	...
	@:noCompletion inline function set_button1(button:DiscordButton):DiscordButton
	{
		return __presence.buttons[0] = button;
	}

	@:noCompletion inline function set_button2(button:DiscordButton):DiscordButton
	{
		return __presence.buttons[1] = button;
	}
}
#end